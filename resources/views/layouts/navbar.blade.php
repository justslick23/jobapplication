    ...
    <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
        ...
        <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-bs-toggle="dropdown" aria-expanded="false" href="#">+ Create New Job</a>
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
                    <h6 class="p-3 mb-0">Job Openings</h6>
                    ...
                    <a class="dropdown-item preview-item" href="#">
                        ...
                        <div class="preview-item-content">
                            <p class="preview-subject ellipsis mb-1">Software Developer</p>
                        </div>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item preview-item" href="#">
                        ...
                        <div class="preview-item-content">
                            <p class="preview-subject ellipsis mb-1">UI/UX Designer</p>
                        </div>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item preview-item" href="#">
                        ...
                        <div class="preview-item-content">
                            <p class="preview-subject ellipsis mb-1">Quality Assurance</p>
                        </div>
                    </a>
                    <div class="dropdown-divider"></div>
                    <p class="p-3 mb-0 text-center">See all job openings</p>
                </div>
            </li>
                ...
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                    ...
                    <a class="dropdown-item preview-item" href="#">
                        ...
                        <div class="preview-item-content">
                            ...
                            <p class="text-muted ellipsis mb-0">New admin added!</p>
                        </div>
                    </a>
                    <div class="dropdown-divider"></div>
                ...
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                    ...
                    <a class="dropdown-item preview-item" href="#"
                       onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        ...
                        <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="preview-subject mb-1">
                            Log out
                        </a>
                    </div>
